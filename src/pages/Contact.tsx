  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Mehmet Resit Gul for AI automation projects, n8n workflow development, and e-commerce efficiency solutions. Available for collaboration." />
      </Helmet>
