...
function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact - Mehmet Resit Gul</title>
        <meta
          name="description"
          content="Get in touch with Mehmet Resit Gul for AI automation projects, n8n workflow development, and e-commerce efficiency solutions. Available for collaboration."
        />
      </Helmet>
      ...
      <section className="min-h-screen flex items-center justify-center py-20 relative z-10 px-4">
        <div className="max-w-4xl mx-auto w-full">
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-8 sm:mb-12 transition-colors duration-300 ${
          ...
          <div
            className={`backdrop-blur-md border rounded-2xl sm:rounded-3xl p-8 sm:p-12 shadow-2xl animate-slide-in stagger-1 ${
              isDark ? 'bg-white/3 border-white/10' : 'bg-gray-800/3 border-gray-800/20'
            }`}
          >
